...
<body>
	<div class="main">
		<div class="text">
			<div class="left">
				<h2 style="color:#491206">500</h2>
			</div>
			<div class="right">
				<h3 style="color:#FF5733;">SORRY! Internal Server Error..!</h3>
				<h4>generic error message, given when no more specific message is suitable</h4>
				<a href="/IPL-2016-EXCEPTIONHANDLING">GO BACK</a>
			</div>
			<div class="clear"></div>
		</div>
		<div class="footer">
			<p>Copyright © 2016 Server ErrorPage. All Rights Reserved | Design by Bridgelabz </p>
		</div>
	</div>
</body>
</html>